...
public class CommentPlugin extends PluginAdapter {
    ...
    void commentResultMap(XmlElement element, IntrospectedTable introspectedTable) {
        ...
        if (!es.isEmpty()) {
            String alias = introspectedTable.getTableConfiguration()
                .getAlias();
            int aliasLen = -1;
            if (alias != null) {
                        ...
                        if (!as.isEmpty()) {
                            ...
                            if (col != null) {
                                ...
                                if (ic != null) {
                                    ...
                                    if (ic.getRemarks() != null && ic.getRemarks()
                                        .length() > 1) {
                                        sb.append("<!-- ");
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        document.getRootElement()
            .addElement(new TextElement("<!-- Your codes goes here!!! -->"));
        document.getRootElement()
            .addElement(new TextElement(""));
        return true;
    }
