...
public class SnowflakesUtil {
    ...
    public static String getNextId() {
        SnowflakesUtil snowflakesUtil = new SnowflakesUtil(0, 0);
        return String.valueOf(snowflakesUtil.nextId());
    }
